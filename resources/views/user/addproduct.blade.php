        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('user.insetproduct') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="qty" type="qty" class="form-control"  name="qty" >
                        ...
                        <div class="form-group{{ $errors->has('rate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="rate" type="rate" class="form-control" name="rate" ">
